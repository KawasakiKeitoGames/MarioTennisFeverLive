...
export async function GET(request: Request) {
  ...
  const [stats, grid, recent, rank, kpiRanks, channelRow, latestDaily] = await Promise.all([
    ...
    // KPI別順位＋平均配信時間
    supabase.rpc("channel_kpi_ranks", { p_channel_id: id, p_days: days }),
